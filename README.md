#famous-scaffold
> A skeleton project of the Famo.us framework to use Bower and Grunt..

[![Build Status](https://travis-ci.org/talves/famous-scaffold.svg?branch=master)](https://travis-ci.org/talves/famous-scaffold) [![Dependency Status](https://david-dm.org/talves/famous-scaffold.svg)](https://david-dm.org/talves/famous-scaffold) [![devDependency Status](https://david-dm.org/talves/famous-scaffold/dev-status.svg)](https://david-dm.org/talves/famous-scaffold#info=devDependencies)
...
## Release History
 * 2014-09-08   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)